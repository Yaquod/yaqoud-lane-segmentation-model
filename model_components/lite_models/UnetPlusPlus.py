...
from model_components.lite_models.heads import RegressionHead, ClassificationHead
from model_components.lite_models.BaseModel import BaseModel
from model_components.lite_models.modules import *

from segmentation_models_pytorch.encoders import get_encoder
from segmentation_models_pytorch.decoders.unetplusplus.decoder import (
    UnetPlusPlusDecoder,
)
...
class UnetPlusPlus(BaseModel):
    ...
    def __init__(
        ...
        | None = None,  # expects ckpt["model_state"] with encoder./decoder. keys
